    ...
    return (
        <div>
            <div className='flex w-10/12 mx-auto justify-between mt-5 items-center h-23'>
                <h1 className='text-2xl md:text-3xl lg:text-4xl font-semibold bg-linear-to-r from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent'>Digitools</h1>
                <ul className='hidden md:grid grid-cols-3 gap-2 ml-2 lg:flex lg:gap-5'>
                ...
                <div className='flex gap-3'>
                    <button className='btn rounded-full'> 
                        <span className='relative'>
                            <LuShoppingCart />
                            <div className='absolute bottom-1 left-2 bg-[#9514FA] rounded-full text-white mask mask-circle p-2'>{selectedProducts.length}</div>
                        </span>
                        </button>
